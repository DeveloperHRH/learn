 ...
 * 
 */
public class LearnSysTimetaskDTO  implements Serializable {
    ...
    /** 创建者,管理操作,用户存user_id*/
    @ApiModelProperty(value = "创建者,管理操作,用户存user_id", name = "createBy",hidden = true)
    ...
    @ApiModelProperty(value = "修改者,管理操作,存字符串,用户操作存 user_id", name = "modifyBy",hidden = true)
    ...
    /** 逻辑删除标识,1删除,0非删除*/
    @ApiModelProperty(value = "逻辑删除标识,1删除,0非删除", name = "deleted",hidden = true)
